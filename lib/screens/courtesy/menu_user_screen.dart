    ...
    return Container(child: Padding(
      ...
      child: Column(
        ...
        Text("Ordine numero: ${_confirmedOrder!.numero}", style: TextStyle(fontWeight: FontWeight.w500,color: Colors.black54,fontSize: 18)),
          Text("Data dell'ordine: ${dateFormatter.format(postgresDateFormatter.parse(_confirmedOrder!.createdAt ?? ''))} ",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.black54,fontSize: 18)),
