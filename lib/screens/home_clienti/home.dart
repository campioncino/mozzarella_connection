...
import 'package:bufalabuona/screens/courtesy/menu_user_screen.dart';
...
import 'package:bufalabuona/utils/store_utils.dart';
...
class _HomeState extends ConsumerState<Home> {
  ...
  static const int MENU_USER_CART = 4;
  static const int MENU_USER_ORDER = 3;
  static const int MENU_USER_STORICO_ORDINI = 3;
  static const int MENU_USER = 10;

  static const int MENU_USER_PROFILO = 2;
  ...
  init() async {
    ...
    */
    ...
    if (_options!= null && _options!['route']!=null) {
      ...
      if (_options!['route'] == 'CARRELLO') {
        _initialIndex= menuItems.keys.firstWhere((k) => menuItems[k]==MENU_USER_CART, orElse:()=> 6);
      }
    }else{
    ...
    _listCart = await AppUtils.retrieveCartItems();
    if(_listCart.isNotEmpty){
      _listCart.forEach((key, value) { counter+=value; });
    }
    ref.read(counterStateProvider.notifier).state = counter;
    setState(() {
      _listCart;
  ...
  _getDrawerItemWidget(int? pos) {
    ...
    case MENU_USER_CART:
     ...
     case MENU_USER_STORICO_ORDINI:
      ...
      case MENU_USER:
        return MenuUserScreen(options: this.widget.options,);
      default:
        return ProfileScreen(options: this.widget.options);
    }
  }
  ...
  Future<List<DrawerItem>> initMenuItems(
    ...
    if (hasProfiloClient) {
      var vetDrawerItems = [
        ...
        DrawerMenuItem(
            MENU_USER_PRODOTTI, "Prodotti", UiIcons.list),
        DrawerMenuItem(MENU_USER_CART, "Carrello", UiIcons.cartShopping),
        DrawerMenuItem(
            MENU_USER_ORDER, "Ordini", UiIcons.cheese),
    ...
    var dataItems = [
      ...
      DrawerMenuItem(MENU_USER_PROFILO, "Profilo", UiIcons.user,
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            // actions: [if(_titleMenu=='Carrello')IconButton(onPressed: (){}, UiIcons.removeShoppingCart)],
          ),
        ...
        items:  <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            icon: Badge.Badge(
                ...
                child: Icon(LineAwesomeIcons.shopping_cart,size: 30,)),
            label: 'Carrello',
          ),
          ///END CARRELLO
          BottomNavigationBarItem(
            ...
            label: 'Menu',
            activeIcon: Icon(LineAwesomeIcons.bars),
          ),
            ],
            ),
         ),
  ...
  void onTabTapped(int index) {
    setState(() {
      ...
      String? title;
      switch(index){
        case 0: _selectedDrawerIndex = MENU_USER_PRODOTTI;  title="Prodotti";break;
        case 1: _selectedDrawerIndex = MENU_USER_CART;  title="Carrello";break;
        case 2: _selectedDrawerIndex = MENU_USER; ;break;
        // case 1: _selectedDrawerIndex =MENU_USER_STORICO_ORDINI;  title="Ordini";break;
        // case 2: _selectedDrawerIndex =MENU_USER_PROFILO;  title="Menu";break;
        // case 3: _selectedDrawerIndex =MENU_USER_CART;  title="Carrello";break;

        default : _selectedDrawerIndex=MENU_USER_PRODOTTI;break;
      }
      ...
      setState(() {
        ...
        _titleMenu = title??'';
        _selectedPage = _getDrawerItemWidget(_selectedDrawerIndex);
      });
        // _selectedDrawerIndex = index;
        // // _selectedItem = d.id;
        // // _titleMenu = d.title;
...
//              child: CustomDialog(buttonText: "OK",description: body,title: title,image: FarmacoIcons.presVetIcon),
  ...
  void checkVersion() async {
    if (await AppUtils.isConnected()) {
      ...
      StoreUtils.checkVersion(context, showOldDeviceDialog: true);
    }
  }
}
