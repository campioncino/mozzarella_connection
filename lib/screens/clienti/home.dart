  ...
  Future<List<DrawerItem>> initMenuItems(
    ...
    if (hasProfiloClient) {
      var vetDrawerItems = [
        ...
        DrawerMenuItem(MENU_USER_CART, "Carrello", Icon(FontAwesomeIcons.cartShopping)),
        DrawerMenuItem(
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            // actions: [if(_titleMenu=='Carrello')IconButton(onPressed: (){}, icon: Icon(Icons.remove_shopping_cart,size: 33,))],
          ),
        ...
        items:  <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            ...
            label: 'Menu',
            activeIcon: Icon(FontAwesomeIcons.bars),
          ),
            ],
            ),
         ),
