...
class _DettaglioReportScreenState extends State<DettaglioReportScreen> {
  ...
  String? _dtReport;
  List? _listData;
  List<ReportProduzioneCasaroJsonData>? _values;
  ...
  void initState() {
    ...
    _values= ReportProduzioneRestService.internal(context).parseCasaroJsonDataList(_listData!);
              ...
              child: Row(
                ...
                children: [
                  Container(
                      ...
                      child: Icon(UiIcons.listIco,size: 50,color: Color(0xFF3BBAD5))),
                  SizedBox(width: 22,),
                  Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildChildRow(BuildContext context, ReportProduzioneCasaroJsonData report, int position){
    if(report.totale==null){
      return AppUtils.emptyList(context, UiIcons.listIco);
    }
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisAlignment: MainAxisAlignment.start,
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Codice: ${report.tipProdCodice ?? ''}"),
                        Text("Dettaglio: ${report.dettaglio ?? ''}"),
                        Text("Prodotto: ${report.tipProdDescrizione ?? ''}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                        // Text("Quantitativo da produrre: ${report.totale/1000} ${report.unimisProduzione}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16)),
                       Text("Quantitativo da produrre: ${report.totale!/1000} KG - ${(report.totale!/report.qtaProduzione!).ceil()} PZ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16)),
  ...
  String calculateHash(List<ReportProduzioneCasaroJsonData>? values){
