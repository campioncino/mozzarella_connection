...
class ReportProduzioneScreen extends StatefulWidget {
  const ReportProduzioneScreen({Key? key}) : super(key: key);

  @override
  State<ReportProduzioneScreen> createState() => _ReportProduzioneScreenState();
}

class _ReportProduzioneScreenState extends State<ReportProduzioneScreen> {
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 22,),
                    Flexible(child: Text("Da questa sezione è possibile generare i report di produzione.\nOgni report contiene il totale dei prodotti in consegna per il giorno selezionato.",style: TextStyle(color: Colors.white,fontSize: 16),)),
                  ],
                ),
              ),
