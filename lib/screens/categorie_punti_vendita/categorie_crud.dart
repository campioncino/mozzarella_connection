...
class CategorieCrud extends StatefulWidget {
  final Categoria? categoria;
  final bool? updateMode;
  final List<Categoria>? categorieList ;

  const CategorieCrud({this.categoria, @required this.updateMode,this.categorieList});

  @override
  State<CategorieCrud> createState() => _CategorieCrudState();
}

class _CategorieCrudState extends State<CategorieCrud> {
  ...
  Future<void> _save(BuildContext context) async {
   ...
   WSResponse resp = await CategorieRestService.internal(context).upsertCategoria(_categoria!);
